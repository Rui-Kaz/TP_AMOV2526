...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  void _refreshList() {
    setState(() {
      _refreshKey =
          UniqueKey(); // Mudar a chave força o FutureBuilder a correr de novo
    });
  }
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ConstrainedBox(
                                constraints: BoxConstraints(
                                  maxWidth: isWideScreen ? 800 : double
                                      .infinity,
                                ),
                                      ...
                                      child: Image.asset(
                                        ...
                                        errorBuilder: (context, error,
                                          ...
                                          return Container(
                                            ...
                                            color: Colors.grey[300],
                                            child: const Icon(Icons
                                                .image_not_supported), // Icone de erro
                                          );
                                        },
                                      ),
                                    ),
                                    ...
                                    onTap: () { // Ao clicar no item
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute( // Navegação para o detalhe
                                          builder: (context) =>
                                              DetailScreen(
                                                  point: point), // Passa o ponto de interesse
                                        ),
                                      ).then((
                                          _) { // Depois de voltar do detalhe...
