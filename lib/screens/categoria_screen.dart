      ...
      body: Stack(
        children: [
          ...
          opacity: 0.1, // Ajusta a transparência (0.0 a 1.0)
            child: Image.asset(
              'assets/imagens/category_background.jpg', // Coloca o caminho da tua imagem
              fit: BoxFit.cover,
              ...
              return Center(
                ...
                return LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    double childAspectRatio = isLandscape ? 1.5 : 1.2;
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(
                                    categoryIcon,
                                    size: isLandscape ? 48 : 64, // Reduz o ícone em landscape
                                  ...
                                  Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: isLandscape ? 14 : 16, // Reduz o texto em landscape
